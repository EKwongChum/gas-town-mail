 ...
 * /swagger-ui.html}. The MCP tools (search_mails / get_mail_by_id / count_mails) are listed in the
 * service README and discoverable by MCP clients via {@code tools/list}.
 */
@Configuration
